...
export const getDashoardStats = TryCatch(async (req, res, next) => {
    let stats = {};
    ...
    if (myCache.has(key))
        ...
        const latestTransactionPromise = Order.find({})
            ...
            .limit(4);
        const [thisMonthOrders, thisMonthUsers, thisMonthProducts, lastMonthOrders, lastMonthUsers, lastMonthProducts, allOrders, usersCount, productsCount, lastSixMonthOrders, categories, femaleUserCount, latestTransaction,] = await Promise.all([
